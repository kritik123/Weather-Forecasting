...
https://github.com/kritik123/Weather-Forecasting/ (the “Site”).
          </p>{" "}
          <br />
          ...
          <br />
          <p>
            I use Hotjar to help me understand how my users use the Site.You can
            read more about how Hotjar uses your Personal Information here: &nbsp;{" "}
            <a
          ...
          <p>
            ...
            >
              http:
              //consumercal.org/california-online-privacy-protection-act-caloppa/#sthash.0FdRbT51.dpuf
            </a>
            .{" "}
          </p>{" "}
          <br />
          ...
          <p>
            ...
            maximum of 24 months and any comments data will be stored
            forever.However, your data is strictly secured and can only be
            accessed by me.{" "}
          </p>{" "}
          <br />
          ...
          <p>
            ...
            me by e - mail at & nbsp;{" "}
            <a
              href="mailto:kkshivanshu@gmail.com"
              target="_blank"
              rel="noopener noreferrer"
              className="link z-0"
            >
              kritikshivanshu@gmail.com{" "}
            </a>{" "}
          </p>{" "}
          <br />
          <p> This policy is effective as of March 21st, 2020. </p>{" "}
        </div>{" "}
      </div>{" "}
    </div>
  );
